  ...
  >
    <div class='flex max-h-[90dvh] w-full max-w-lg flex-col overflow-hidden rounded-2xl bg-neutral-900 shadow-2xl'>
      ...
      <div class='flex items-start justify-between px-6 pb-4 pt-6'>
        ...
        <button
          class='rounded-lg p-2 text-neutral-400 hover:bg-neutral-800 hover:text-white disabled:cursor-not-allowed disabled:opacity-60'
          :disabled='isDeleting'
          @click="$emit('close')"
        >
      ...
      <div class='flex gap-3 border-t border-white/10 px-6 py-4'>
        <button
          ...
          class='flex-1 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60'
          :disabled='isDeleting'
          @click="$emit('edit')"
        >
          수정
        ...
        <button
          v-if='isEditing'
          class='flex-1 rounded-lg bg-neutral-700 px-4 py-2 text-sm font-medium text-white hover:bg-neutral-600 disabled:cursor-not-allowed disabled:opacity-60'
          :disabled='isDeleting'
          @click="$emit('close')"
        >
          취소
        ...
        <button
          v-if='isEditing'
          class='flex-1 rounded-lg bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-60'
          :disabled='isDeleting'
          @click='handleSave'
        >
          저장
        ...
        <button
          v-if='canManage'
          class='flex-1 rounded-lg bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-60'
          :disabled='isDeleting'
